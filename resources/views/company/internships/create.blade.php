...
<div class="container-fluid">
    ...
    <div class="mb-4 d-flex justify-content-between align-items-center">
        <div>
            <h2 class="fw-bold mb-1" style="color: #1f0822;">Post Internship Listing</h2>
            <p class="text-muted">Create a new opportunity for students on the platform.</p>
        </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="internship_name" class="form-control @error('internship_name') is-invalid @enderror" 
                                   value="{{ old('internship_name') }}" placeholder="e.g. Software Engineering Intern" required>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="industry" class="form-select @error('industry') is-invalid @enderror" required>
                                ...
                                <option value="IT/Information Technology" {{ old('industry') == 'IT/Information Technology' ? 'selected' : '' }}>IT / Tech</option>
                                <option value="Engineering" {{ old('industry') == 'Engineering' ? 'selected' : '' }}>Engineering</option>
                                <option value="Business/Accounting/Finance" {{ old('industry') == 'Business/Accounting/Finance' ? 'selected' : '' }}>Business / Finance</option>
                                <option value="Creative/Design" {{ old('industry') == 'Creative/Design' ? 'selected' : '' }}>Creative / Design</option>
                                <option value="Healthcare/Medical" {{ old('industry') == 'Healthcare/Medical' ? 'selected' : '' }}>Healthcare</option>
                                <option value="Admin/Human Resource" {{ old('industry') == 'Admin/Human Resource' ? 'selected' : '' }}>Admin / HR</option>
                            </select>
                            @error('industry')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" 
                                      rows="8" placeholder="Outline the job description, core responsibilities, and required qualifications..." required>{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="contact_phone" class="form-control @error('contact_phone') is-invalid @enderror" 
                                   value="{{ old('contact_phone') }}" placeholder="e.g. +603-12345678" required>
                            @error('contact_phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="location-input" name="location" class="form-control @error('location') is-invalid @enderror" 
                                       value="{{ old('location') }}" placeholder="Enter address or search location" required>
                        ...
                        <input type="hidden" name="lat" id="lat" value="{{ old('lat', '3.1390') }}">
                        <input type="hidden" name="lng" id="lng" value="{{ old('lng', '101.6869') }}">
                    </div>
                </div>
